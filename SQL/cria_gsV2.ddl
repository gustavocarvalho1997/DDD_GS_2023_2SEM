...
CREATE TABLE t_obs_resultado (
    ...
    id_exame         NUMBER(5) NOT NULL,
    vl_parametro_1   NUMBER(3, 1),
    vl_parametro_2   NUMBER(3, 1),
    vl_parametro_3   NUMBER(3, 1),
    vl_parametro_4   NUMBER(3, 1),
    vl_parametro_5   NUMBER(3, 1),
    vl_parametro_6   NUMBER(3, 1),
    vl_parametro_7   NUMBER(3, 1),
    vl_parametro_8   NUMBER(3, 1),
    vl_parametro_9   NUMBER(3, 1),
    vl_parametro_10  NUMBER(3, 1),
    vl_parametro_11  NUMBER(3, 1),
    vl_parametro_12  NUMBER(3, 1),
    vl_parametro_13  NUMBER(3, 1),
    vl_parametro_14  NUMBER(3, 1),
    vl_parametro_15  NUMBER(3, 1),
    vl_parametro_16  NUMBER(3, 1),
    vl_parametro_17  NUMBER(3, 1)
);
